...
p = Processor('Intel', 'Core i5 7740X', 5500000)
ram = RandomAccessMemory('V-Gen', 'DDR4 SODimm PC19200/2400MHz', 400000)
hdd = HardDiskSATA('Seagate', 'HDD 2.5 inch', 300000)

print("\n\t\t\tOVERLOADING COMPUTER PART")
print("=================================================================================")
p.Tampil()
ram.Tampil("8GB")
hdd.Tampil("256GB", 7200)
print("=================================================================================\n")